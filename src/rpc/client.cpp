...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "adv_connect", 2, "v2transport" },
    { "adv_disconnect", 0, "peer_id" },
    { "adv_sendrawmessage", 0, "peer_id" },
    { "adv_buildblock", 1, "version" },
    { "adv_buildblock", 2, "time" },
    { "adv_buildblock", 4, "nonce" },
    { "adv_buildblock", 6, "txs" },
    { "adv_buildblock", 8, "commit" },
    { "adv_buildblock", 9, "solve" },
    { "adv_sendblock", 0, "peer_id" },
    { "adv_sendblock", 2, "with_witness" },
    { "adv_chaoswallet_setup", 0, "range" },
    { "adv_createchaostx", 0, "options" },
