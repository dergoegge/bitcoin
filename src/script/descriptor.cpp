...
public:
    ...
    virtual bool HavePrivateKeys(int pos, const SigningProvider& arg) const
    {
        ...
        GetPrivKey(pos, arg, tmp_provider);
...
public:
    ...
    bool HavePrivateKeys(int pos, const SigningProvider& arg) const override
    {
        return std::ranges::all_of(m_participants, [&](const auto& prov) { return prov->HavePrivateKeys(pos, arg); });
    }
...
public:
    ...
    bool HavePrivateKeys(const SigningProvider& arg) const override
    {
        ...
        for (const auto& pubkey : m_pubkey_args) {
            if (!pubkey->HavePrivateKeys(0, arg)) return false;
        }
