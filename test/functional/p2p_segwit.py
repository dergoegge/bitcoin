...
class SegWitTest(BitcoinTestFramework):
    ...
    def test_witness_sigops(self):
        ...
        for i in range(p2sh_outputs - 1):
            ...
            tx4.vin.append(CTxIn(COutPoint(tx3.txid_int, i), CScript([script])))
        ...
        tx4.vin.append(CTxIn(COutPoint(tx3.txid_int, p2sh_outputs - 1), CScript([redeem_script_justright])))
        ...
        self.utxo.pop(0)
        self.utxo.append(UTXO(tx4.txid_int, 0, tx4.vout[0].nValue))
