...
def main():
    ...
    try:
        while True:
            ...
            cycles_without_finds = afl_whatsup(output_dir=args.output)["cycles_without_finds"]
...
def start_fuzzers(args):
    ...
    while True:
        if afl_whatsup(args.output)["fuzzers_alive"] > 0:
            break
...
def fuzz_main(target: str, input_dir: str, output_dir: str, nyx: bool, dictionary: str):
    args = [
...
def fuzz_secondary(i: int, target: str, input_dir: str, output_dir: str, nyx: bool, dictionary: str):
    args = [
        get_afl_binary("afl-fuzz"),
        "-t", "5000",
        "-i", input_dir, "-o", output_dir,
...
def minimize_corpus(target: str, input_dir: str, output_dir: str, nyx: bool, cores: int):
    ...
    # Note: we only need to copy the inputs from the main fuzzer due to AFL_FINAL_SYNC.
